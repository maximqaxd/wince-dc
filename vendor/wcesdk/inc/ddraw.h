...
/*
 * Special Dragon-only flags to PAL stretch modes
 */

#define	DDSDM_PALHEIGHTRATIO_1_033				0x0800
#define	DDSDM_PALHEIGHTRATIO_1_066				0x1000
#define	DDSDM_PALHEIGHTRATIO_1_100				0x2000
#define	DDSDM_PALHEIGHTRATIO_1_133				0x4000
#define	DDSDM_PALHEIGHTRATIO_1_166				0x8000
...
/*
 * Special Dragon-only flag to request a store-q video memory YUV surface
 * instead of a system memory YUV surface
 */
#define DDLOCK_DIRECT                           0x01000000L

/*
 * Special Dragon-only flag to lock a surface without flushing pending
 * render
 */
#define DDLOCK_DYNAMIC                           0x02000000L

/*
 * Special Dragon-only flag to lock a VQ-compressed surface
 */
#define DDLOCK_COMPRESSED                        0x04000000L


/*
 * Special Dragon-only flag to lock a twiddled surface
 */
#define DDLOCK_OPTIMIZED                        0x08000000L
