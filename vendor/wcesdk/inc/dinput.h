...
#define DIPROP_REGION_NORTH_AMERICA 0x01
#define DIPROP_REGION_JAPAN         0x02
#define DIPROP_REGION_ASIA          0x04
#define DIPROP_REGION_EUROPE        0x08
#define DIPROP_WORLDREGION      MAKEDIPROP(21)

#define DIPROP_EXTRACT_EXPDIRECTION(direction, devNum) (((direction) >> (((devNum) - 1) * 2)) & 0x03)
#define DIPROP_EXPDIR_TOP       0x00
#define DIPROP_EXPDIR_BOTTOM    0x01
#define DIPROP_EXPDIR_LEFT      0x02
#define DIPROP_EXPDIR_RIGHT     0x03
#define DIPROP_EXPDIRECTION     MAKEDIPROP(22)

#define DIPROP_CURRENT          MAKEDIPROP(23)            
#endif //!UNDER_CE
