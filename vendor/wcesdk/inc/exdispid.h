...
#define DISPID_SECURITYICONCHANGE 114   // sent when the security icon needs
#define DISPID_VSCROLLCHANGE      115   // sent to indicate state of vscroll buttons
#define DISPID_ONBROWSERERROR     116   // sent when an error needs to be reported to the user
