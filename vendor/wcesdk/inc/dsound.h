...
// {86E3F9F1-3DD4-11d2-B093-0060088F5846}
DEFINE_GUID(DSPROPSETID_Reverb, 
0x86e3f9f1, 0x3dd4, 0x11d2, 0xb0, 0x93, 0x0, 0x60, 0x8, 0x8f, 0x58, 0x46);

// {5A307499-4838-11d2-B09B-0060088F5846}
DEFINE_GUID(DSPROPSETID_MixerProp, 
0x5a307499, 0x4838, 0x11d2, 0xb0, 0x9b, 0x0, 0x60, 0x8, 0x8f, 0x58, 0x46);

// {07E412D0-4A93-11d2-AC7F-000000000000}
DEFINE_GUID(DSPROPSETID_SetDspProgram, 
0x7e412d0, 0x4a93, 0x11d2, 0xac, 0x7f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0);

// For IDirectSoundCaptureBuffer
// {2F272851-7B5C-11d2-983C-00C04F72C4D2}
DEFINE_GUID(DSPROPSETID_Gain, 
0x2f272851, 0x7b5c, 0x11d2, 0x98, 0x3c, 0x0, 0xc0, 0x4f, 0x72, 0xc4, 0xd2);

// Master Control
// {23498CB9-CDEC-11d3-9BCB-00A0C9C9F60E}
DEFINE_GUID(DSPROPSETID_MasterControl, 
0x23498cb9, 0xcdec, 0x11d3, 0x9b, 0xcb, 0x0, 0xa0, 0xc9, 0xc9, 0xf6, 0xe);


typedef struct
	{
	DWORD imixerLeftorMono;
	DWORD imixerRight;
	DWORD fUseVolume;
	DWORD sndvolDspLeftorMono;
	DWORD sndvolNoDspLeftorMono;
	DWORD sndvolDspRight;
	DWORD sndvolNoDspRight;
	} DIRECTSOUNDBUFFER_MIXERPROPS;

typedef struct
	{
	DWORD imixerQSoundStart;
	DWORD imixerQSoundEnd;
	DWORD cbDspData1;
	PBYTE pbDspData1;
	DWORD cbDspData2;
	PBYTE pbDspData2;
	} DIRECTSOUND_DSPPROPS;

typedef struct
	{
	DWORD sndvolMaster;
	} DIRECTSOUND_MASTERCONTROL;
...
// The system memory buffer's size is not properly aligned
// (must be a multiple of 32 bytes for mono, 64 bytes for stereo)
#define DSERR_NOT32BYTEALIGNED             MAKE_DSHRESULT(255)
