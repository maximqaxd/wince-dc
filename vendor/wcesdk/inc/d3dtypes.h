...
typedef enum _D3DLIGHTSTATETYPE {
	...
	D3DLIGHTSTATE_BUMPAMBIENT		= 10,
	D3DLIGHTSTATE_BUMPINTENSITY		= 11,
	D3DLIGHTSTATE_BUMPDIRECTION 	= 12,
...
#ifdef DRAGON
    D3DRENDERSTATE_SHADOWENABLE	      = 140,
    D3DRENDERSTATE_SHADOWLEVEL        = 141,
    D3DRENDERSTATE_VOLUMEENABLE       = 142,
    D3DRENDERSTATE_SWCULLMODE         = 143,   /* D3DCULL */
    D3DRENDERSTATE_HWCULLMODE         = 144,   /* D3DCULL */
#endif
...
#ifdef DRAGON
#define D3DFVF_DIFFUSE1		0x1000
#define D3DFVF_SPECULAR1	0x2000
#endif
...
#ifdef DRAGON
typedef struct _D3DDRAWPRIMITIVESTRIDEDDATA_VOLUME
{
    D3DDP_PTRSTRIDE position;
    D3DDP_PTRSTRIDE normal;
    D3DDP_PTRSTRIDE diffuse;
    D3DDP_PTRSTRIDE specular;
    D3DDP_PTRSTRIDE textureCoords[D3DDP_MAXTEXCOORD];
    D3DDP_PTRSTRIDE diffuse1;
    D3DDP_PTRSTRIDE specular1;
} D3DDRAWPRIMITIVESTRIDEDDATA_VOLUME, *LPD3DDRAWPRIMITIVESTRIDEDDATA_VOLUME;

typedef struct _D3DMULTIMATRIX
{
	LPVOID			lpvVertices;
	LPD3DMATRIX		lpd3dMatrices;
	LPVOID			lpvLightDirs;
	LPD3DCOLOR		lpLightTable;
} D3DMULTIMATRIX;
typedef D3DMULTIMATRIX *LPD3DMULTIMATRIX;
