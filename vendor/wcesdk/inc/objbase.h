...
// Some definitions so we can include the real wtypes.h from nt
...
#define hyper _int64
#define MIDL_uhyper unsigned _int64
#ifndef _FILETIME_
#define _FILETIME_
#endif
#ifndef _SYSTEMTIME_
...
//WINOLEAPI_(void) CoFreeLibrary(HINSTANCE hInst); // unsafe & not supported any more. Use CoFreeUnusedLibraries()
