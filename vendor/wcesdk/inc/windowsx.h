...
Module Name:windowsx.h

Purpose: Macro APIs, window message crackers, and control APIs 
...
#define FORWARD_WM_GETDLGCODE(hwnd, lpmsg, fn) \
    (UINT)(DWORD)(fn)((hwnd), WM_GETDLGCODE, (lpmsg ? lpmsg->wParam : 0), (LPARAM)(PMSG)(lpmsg))
...
#ifdef WINCEOEM
#include <pwindowx.h>	// internal defines 
#endif
