...
/
/ This version has some additional functionality for DreamShell ISO Loader
/
/----------------------------------------------------------------------------*/
...
FRESULT f_read_async (FIL* fp, void* buff, UINT btr);			    /* Async read data from a file */
FRESULT f_pre_read (FIL* fp, DWORD btr);					        /* Pre-read data from a file */
FRESULT f_write (FIL* fp, const void* buff, UINT btw, UINT* bw);	/* Write data to a file */
FRESULT f_forward (FIL* fp, UINT(*func)(const BYTE*,UINT), UINT btf, UINT* bf);	/* Forward data to the stream */
FRESULT f_lseek (FIL* fp, DWORD ofs);								/* Move file pointer of a file object */
FRESULT f_truncate (FIL* fp);										/* Truncate file */
FRESULT f_sync (FIL* fp);											/* Flush cached data of a writing file */
FRESULT f_poll(FIL* fp, UINT *bp);                                  /* Polling for async operations */
FRESULT f_abort(FIL* fp);                                           /* Stop async operations */
